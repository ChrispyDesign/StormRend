...
namespace BhaVE.Core
{
	...
	public sealed class BhaveTree : ScriptableObject
	{
		...
		#region Core Methods
		/// <summary>
		/// To be called once at upon startup. Use this to construct.
		/// </summary>
		internal void RunInitiate(BhaveAgent agent) => root.OnInitiate(agent);

		/// <summary>
		/// To be called once each tick cycle BEFORE this tree is evaluated
		/// </summary>
		...
		/// <summary>
		/// To be called onces each tick cycle AFTER this tree is evaluated
		/// </summary>
